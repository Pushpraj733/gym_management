...
const fetchMembership = async() =>{
  await axios.get('https://gym-management-9zrp.onrender.com/plans/get-membership',{ withCredentials:true}).then((res)=>{
console.log(res);
...
const handleAddmembership= async()=>{
  await axios.post('https://gym-management-9zrp.onrender.com/plans/add-membership',inputField,{ withCredentials:true}).then((response=>{
