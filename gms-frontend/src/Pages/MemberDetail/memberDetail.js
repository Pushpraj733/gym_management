...
const MemberDetail = () => {
    ...
    useEffect(()=>{
        ...
        const fetchMembership=async()=>{
            axios.get('https://gym-management-v9wi.onrender.com/plans/get-membership',{withCredentials:true}).then((response)=>{
...
await axios.get(`https://gym-management-v9wi.onrender.com/members/get-member/${id}`,{withCredentials:true}).then((response)=>{
...
const handleSwitchBtn=async()=>{
    ...
    await axios.post(`https://gym-management-v9wi.onrender.com/members/change-status/${id}`,{status:statuss},{withCredentials:true}).then((response)=>{
...
const handleRenewSaveBtn=async()=>{
    await axios.put(`https://gym-management-v9wi.onrender.com/members/update-member-plan/${id}`,{membership:planMember},{withCredentials:true}).then((response)=>{
setData(response.data.member);
toast.success(response.data.message);
    }).catch(err=>{
        console.log(err);
