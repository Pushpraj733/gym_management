...
await axios.get(`https://gym-management-9zrp.onrender.com/members/all-member?skip=${skip}&limit=${limits}`,{withCredentials:true}).then((response)=>{
...
const handleSearchData=async()=>{
  ...
  await axios.get(`https://gym-management-9zrp.onrender.com/members/searched-members?searchTerm=${search}`,{withCredentials:true}).then((response)=>{
console.log(response);
